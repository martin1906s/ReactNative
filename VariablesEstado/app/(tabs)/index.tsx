  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.titleContainer}>
        <ThemedText type="title">Contador Estado: {contadorEstado}</ThemedText>
      </ThemedView>
      <ThemedView style={styles.titleContainer}>
        <ThemedText type="title">Contador Vidas: {contadorVidas}</ThemedText>
      </ThemedView>
      <ThemedView style={styles.stepContainer}>
        <Button title='Incrementar' onPress={incrementar}></Button>
        <Button title='Decrementar' onPress={decrementar}></Button>
        <Button title='Perder Vida' onPress={decrementarVidas}></Button>
        <Button title='Premiar Vidas' onPress={premiarVidas}></Button>
